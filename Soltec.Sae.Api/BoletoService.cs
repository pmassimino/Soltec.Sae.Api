    ...
    public class BoletoService
    {
        ...
        public List<BoletoPendienteLiquidar> ListPendiente(string idCuenta, string idCosecha, DateTime fecha,DateTime fechaHasta)
        {
            ...
            var result = from r in tmpResult                            
                            ...
                            select new BoletoPendienteLiquidar { Id = r.Id,IdCosecha=r.IdCosecha,NombreCosecha = r.Cosecha.Nombre,IdCuenta = r.IdCuenta,NombreCuenta =r.Cuenta.Nombre,
                                Precio= r.Precio,PesoNeto = r.PesoNeto,PesoLiquidado = details.Sum(l=>l.Liquidado), PesoPendienteLiquidar = r.PesoNeto - details.Sum(l => l.Liquidado)                            };
