...
{
    public class ClaseVentaService
    {
        public ClaseVentaService(string connectionStringBase)
        {
        ...
        public List<EntityGeneric> List()
        {
            ...
            command.CommandText = "SELECT cod,nom FROM faccla where !empty(cod) and !empty(nom)";
        ...
        public EntityGeneric FindOne(string id)
        {
            ...
            cnn.Open();
            OleDbCommand command = cnn.CreateCommand();
            command.CommandText = "SELECT cod,nom FROM faccla where !empty(cod) and !empty(nom) and cod ='" + id + "'";
            OleDbDataReader reader = command.ExecuteReader();
