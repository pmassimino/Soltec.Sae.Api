...
namespace Soltec.Sae.Api
{
    public class CertificadoService
    {
        ...
        private Certificado Parse(OleDbDataReader reader)
        {
            ...
            cosecha.Id = reader["cosecha"].ToString().Trim();
            cosecha.Nombre = reader["NombreCosecha"].ToString().Trim();
            cosecha.NombreCereal = reader["NombreCereal"].ToString().Trim();
            cosecha.IdCereal = reader["Cereal"].ToString().Trim();
            item.Cosecha = cosecha;
            item.IdCuenta = reader["productor"].ToString().Trim();
            Sujeto cuenta = new Sujeto();
            cuenta.Id = reader["productor"].ToString().Trim();
